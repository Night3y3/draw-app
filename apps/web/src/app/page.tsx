        ...
        <section className="py-20 bg-muted/50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Join thousands of satisfied teams and artists using CollabCanvas
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  quote:
                    "CollabCanvas transformed how our design team works together. The real-time collaboration is seamless.",
                  author: "Sarah Johnson",
                  role: "Creative Director, DesignCo",
                },
                {
                  quote:
                    "As a remote team, we needed a tool that could bring us together. CollabCanvas does exactly that and more.",
                  author: "Michael Chen",
                  role: "Product Manager, TechStart",
                },
                {
                  quote:
                    "The intuitive interface and powerful features make this the best collaborative drawing tool I've ever used.",
